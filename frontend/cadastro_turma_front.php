...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="bg-blue-700 text-white p-4 shadow-md">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="cadastro_professor_front.php" class="mx-2 hover:underline font-bold">Professor</a>
    ...
    <div class="max-w-3xl mx-auto bg-white mt-10 p-8 rounded-xl shadow">
        ...
        <form class="grid gap-4">
            <input type="text" placeholder="Nome turma" class="form-input">
            <input type="email" placeholder="Curso" class="form-input">
            <input type="text" placeholder="Professor Responsavel" class="form-input">
            <input type="text" placeholder="Horario" class="form-input">
            <input type="date" placeholder="Data de inicio " class="form-input">
            <input type="text" placeholder="Quantidade de alunos" class="form-input">
            <button type="submit" class="btn-submit">Cadastrar Turma</button>
        </form>
    </div>
