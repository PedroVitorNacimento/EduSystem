...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-blue-700 text-white p-4 shadow-md">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="cadastro_curso.html" class="mx-2 hover:underline">Curso</a>
    ...
    <div class="max-w-3xl mx-auto bg-white mt-10 p-8 rounded-xl shadow">
        <h1 class="text-2xl font-bold text-blue-700 mb-6">Cadastro de Professor</h1>
        <form class="grid gap-4">
            ...
            <input type="text" placeholder="Área de Formação" class="form-input">
            <input type="text" placeholder="Especialização" class="form-input">
